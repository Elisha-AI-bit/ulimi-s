          ...
          {user?.role === 'farmer' && (
            <>
              <button className="flex items-center space-x-3 p-4 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors">
                ...
                <span className="font-medium text-emerald-700">Add New Farm</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
                <Wheat className="h-6 w-6 text-green-600" />
                <span className="font-medium text-green-700">Plant New Crop</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                <ShoppingCart className="h-6 w-6 text-blue-600" />
                <span className="font-medium text-blue-700">List Product</span>
              </button>
            </>
          )}
          ...
          {user?.role === 'customer' && (
            <>
              <button className="flex items-center space-x-3 p-4 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors">
                ...
                <span className="font-medium text-emerald-700">Browse Marketplace</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                <Package className="h-6 w-6 text-blue-600" />
                <span className="font-medium text-blue-700">Track Orders</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-amber-50 hover:bg-amber-100 rounded-lg transition-colors">
                <TrendingUp className="h-6 w-6 text-amber-600" />
                <span className="font-medium text-amber-700">Price Trends</span>
              </button>
            </>
          )}
          ...
          {user?.role === 'admin' && (
            <>
              <button className="flex items-center space-x-3 p-4 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors">
                ...
                <span className="font-medium text-emerald-700">Manage Users</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                <CheckCircle className="h-6 w-6 text-blue-600" />
                <span className="font-medium text-blue-700">Review Listings</span>
              </button>
              <button className="flex items-center space-x-3 p-4 bg-amber-50 hover:bg-amber-100 rounded-lg transition-colors">
                <BarChart3 className="h-6 w-6 text-amber-600" />
                <span className="font-medium text-amber-700">View Analytics</span>
              </button>
            </>
          )}
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <span className="text-gray-700">New tomato crop planted in Mwanza Family Farm</span>
            <span className="text-gray-500 text-sm ml-auto">2 hours ago</span>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-gray-700">Order #12345 shipped successfully</span>
            <span className="text-gray-500 text-sm ml-auto">5 hours ago</span>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            <div className="w-2 h-2 bg-amber-500 rounded-full"></div>
            <span className="text-gray-700">Weather alert: Heavy rains expected in Lusaka</span>
